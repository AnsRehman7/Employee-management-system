    ...
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <label className="block">
          ...
          <div className="mt-2 flex gap-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 transition focus-within:border-emerald-600 focus-within:bg-white focus-within:ring-4 focus-within:ring-emerald-600/10">
