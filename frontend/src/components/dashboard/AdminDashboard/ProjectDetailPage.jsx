...
const ProjectDetailPage = () => {
  ...
  if (loading) {
    return <AppShell title="Project detail" subtitle="Loading portfolio information."><div className="py-24 text-center"><CardSkeleton label="Loading project" lines={4} /></div></AppShell>;
  }
