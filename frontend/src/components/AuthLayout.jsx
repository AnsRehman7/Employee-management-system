...
const AuthLayout = ({
  ...
  <main className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-6 text-slate-950 sm:px-6 sm:py-10">
    <div className="grid w-full max-w-5xl overflow-hidden rounded-2xl bg-white shadow-2xl shadow-slate-300/60 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1fr)]">
      <section className="relative hidden flex-col justify-between overflow-hidden bg-[#0b2b36] p-9 text-white lg:flex xl:p-10">
        ...
        <div className="relative">
          ...
          <p className="mt-11 text-[11px] font-bold uppercase tracking-[0.14em] text-emerald-400">
            {panelEyebrow}
          </p>
          <h1 className="mt-4 max-w-md text-[2.1rem] font-bold leading-[1.18] tracking-tight text-white xl:text-[2.35rem]">
            {panelTitle}
          </h1>
          <p className="mt-4 max-w-sm text-sm leading-6 text-slate-400">{panelText}</p>
        ...
        <div className="relative mt-10 flex items-center gap-2 text-xs font-medium text-slate-500">
          <FiClock className="h-4 w-4" />
          Built for everyday operations
        </div>
      </section>

      <section className="flex min-w-0 items-center justify-center bg-white px-6 py-10 sm:px-10 sm:py-12">
        <div className="w-full max-w-sm">
          ...
          <h2 className="mt-2 text-[1.65rem] font-bold leading-tight tracking-tight text-slate-950">{title}</h2>
